...
let s:colors = {
      ...
      \ "background": get(s:overrides, "background", { "gui": "#aa00282C34", "cterm": "235", "cterm16": "NONE" }),
      \ "comment_grey": get(s:overrides, "comment_grey", { "gui": "#76A5AF", "cterm": "59", "cterm16": "7" }),
      ...
      \ "visual_grey": get(s:overrides, "visual_grey", { "gui": "#101B1B", "cterm": "237", "cterm16": "8" }),
