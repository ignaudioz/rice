let s:transparent = [ '#a00000000', 234 ]
...
let s:p.tabline.middle = [ [s:black, s:transparent] ]
let s:p.tabline.tabsel  = [ [ s:black, s:orange, 'bold' ] ]

let g:lightline#colorscheme#transayu#palette = lightline#colorscheme#flatten(s:p)
